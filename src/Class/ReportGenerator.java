...
public class ReportGenerator {
    ...
    private static String generateReportHelper(double[][] salesData, int day) {
        ...
        report.append("\n");
        return report.toString() + generateReportHelper(salesData, day + 1); // Llamada recursiva
    }
}
/**
 * Genera un reporte para un día específico, incluyendo todas las ventas de ese
 * día. Hace esto de forma recursiva para procesar todos los días.
 */
